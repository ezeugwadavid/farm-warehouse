...
const FingerprintReg = ({ handleBack, handleNext }) => (
	<div className='fingerprint-container'>
        ...
        Security - Setup Fingerprint <span className='optional-italic'>(Optional)</span>
        </div>

        <div className="finger-print-box">
            <div className="box-header">Capture Fingerprint (Your L-R Index fingers)</div>
            ...
            <div className="thumb-info">
                ...
                scanner to capture your fingerprint. 
                Ensure your finger covers the entire scanner.
                </div>
            </div>
